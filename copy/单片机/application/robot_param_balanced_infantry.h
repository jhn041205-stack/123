...
#define ENABLE_CHASSIS_X_POSITION_FEEDBACK 0  // 0: 启用全量x/yaw反馈, 0: 使用限幅后的x/yaw反馈
#define CHASSIS_X_POSITION_FEEDBACK_LIMIT 0.01f  // x反馈非全量模式下的限幅上限
#define CHASSIS_YAW_FEEDBACK_LIMIT 0.01f  // yaw角反馈非全量模式下的限幅上限
#define CHASSIS_RC_DEADLINE    20 // 摇杆死区
...
#define CHASSIS_X_BALANCE_OFFSET (-0.82f)  // 建模偏差补偿: 输入控制器的前向位移基础偏置
